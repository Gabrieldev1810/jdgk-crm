...
function filterSchema(unfilteredSchema, options) {
    ...
    return {
        ...
        types: unfilteredSchema.types.map((t) => {
            var _a;
            if (t.kind !== pg_schema_introspect_1.TypeKind.Enum)
                return t;
            const ignoredValues = (_a = options.ignoreEnumValues) === null || _a === void 0 ? void 0 : _a[t.typeName];
            if (!(ignoredValues === null || ignoredValues === void 0 ? void 0 : ignoredValues.length))
                return t;
            return {
                ...t,
