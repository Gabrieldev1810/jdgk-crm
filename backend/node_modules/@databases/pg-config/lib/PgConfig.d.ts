...
export declare enum PgTypesDomainTypeMode {
    strict_brand = "strict_brand",
    loose_brand = "loose_brand",
    alias = "alias",
    inline = "inline"
}
export declare enum PgTypesEnumTypeMode {
    enum = "enum",
    union_alias = "union_alias",
    union_alias_with_object = "union_alias_with_object",
    inline = "inline"
}
export declare enum PgTypesPrimaryKeyTypeMode {
    strict_brand = "strict_brand",
    loose_brand = "loose_brand",
...
export declare const PgConfigSchema: ft.Runtype<PgConfig>;
